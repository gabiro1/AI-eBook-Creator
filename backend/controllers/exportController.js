...
// BLOCK MARKDOWN → DOCX PARAGRAPHS
export const processMarkdownToDocs = (markdown) => {
  ...
  try {
    ...
    (book.chapters || []).forEach((chapter, index) => {
      try {
        ...
        const contentParagraphs = processMarkdownToDocs(
          chapter.content || '',
        );
    ...
    res.send(buffer); // FIX: was req.send
  } catch (error) {
...
// INLINE → PDF
export const renderInlineTokens = (doc, tokens, options = {}) => {
...
// MARKDOWN → PDF
export const renderMarkDown = (doc, markdown) => {
